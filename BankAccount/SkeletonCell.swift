...
//  BankAccount
//
//  Created by Beltrami Dias Batista, Thiago on 26/12/22.
//
...
class SkeletonCell: UITableViewCell, SkeletonLoadable {
    ...
    private func setup() {
        ...
        let chevronImage = UIImage(systemName: "chevron.right")!.withTintColor(.primaryGreen, renderingMode: .alwaysOriginal)
